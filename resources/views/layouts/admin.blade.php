            ...
            <nav class="flex-1 py-4 px-3 space-y-1 overflow-y-auto">
                ...
                <a href="{{ route('dashboard') }}" @click="sidebarOpen = false" class="flex items-center px-3 py-2 rounded text-sm text-gray-400 hover:text-white hover:bg-[#1a1a1a]">
                    ...
                    @if(isset($navUnreadChatCount) && $navUnreadChatCount > 0)
                        <span class="bg-red-500 text-white text-[10px] font-bold rounded-full min-w-[18px] h-[18px] flex items-center justify-center px-1 ml-2">{{ $navUnreadChatCount }}</span>
                    @endif
                </a>
                ...
                <a href="{{ route('admin.visitors.index') }}" class="flex items-center px-3 py-2 rounded text-sm {{ request()->routeIs('admin.visitors.*') ? 'bg-[#fe9e00] text-black font-medium' : 'text-gray-400 hover:text-white hover:bg-[#1a1a1a]' }}">
                    ...
                    <span class="flex-1">Visitors</span>
                    @if(isset($navVisitorCount) && $navVisitorCount > 0)
                        <span class="bg-[#222] text-[#fe9e00] text-[10px] font-bold rounded-full min-w-[18px] h-[18px] flex items-center justify-center px-1 border border-[#333] ml-2">{{ $navVisitorCount }}</span>
                    @endif
                </a>
